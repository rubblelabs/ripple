...
const (
	...
	NICKNAME         LedgerEntryType = 0x6e // 'C'
	NFTOKEN_PAGE     LedgerEntryType = 0x50 // 'C'
	NFTOKEN_OFFER    LedgerEntryType = 0x37 // 'C'
	CONTRACT         LedgerEntryType = 0x63 // 'C'
